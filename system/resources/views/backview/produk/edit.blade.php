                            ...
                            <div class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="id_kategori" class="form-control">
                                                ...
                                                <option @if ($kategori->id == $produk->id_kategori) selected @endif value="{{$kategori->id}}"> {{$kategori->nama_kategori}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="id_penjual" class="form-control">
                                                ...
                                                <option @if ($penjual->id == $produk->id_penjual) selected @endif value="{{$penjual->id}}"> {{$penjual->nama_toko}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" class="form-control" placeholder="foto" name="foto" accept=".png, .jpg, .jpeg">
                                        </div>
                                    </div>
